...
if commandline_args.load:
    generator.load_weights("mnist_ss_generator.h5")
    discriminator.load_weights("mnist_ss_discriminator.h5")
...
def train_for_n(epochs=5000, plt_frq=25,BATCH_SIZE=32):
    ...
    for e in tqdm(range(epochs)):  
        ...
        if e%plt_frq==plt_frq-1:
            generator.save_weights("mnist_ss_generator.h5")
            discriminator.save_weights("mnist_ss_discriminator.h5")
